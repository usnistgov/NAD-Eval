...
def Malicious ( pop_size , scan_rate , susc_size , inf , code , count ) : 
    ...
    ### .csv ###
    Malicious_filename_1 = "[" + str ( int ( pop_size ) ) + "_" + str ( int ( scan_rate ) ) + "_" + str ( int ( susc_size ) ) + "_" + str ( int ( code ) ) + name + "_" + str ( time ) + "]" + ".csv" 
    open ( Malicious_filename_1 , 'w' ).close() 
    
    ### .txt ###    
    Malicious_filename_2 = "[" + str ( int ( pop_size ) ) + "_" + str ( int ( scan_rate ) ) + "_" + str ( int ( susc_size ) ) + "_" + str ( int ( code ) ) + name + "_" + str ( time ) + "]" + ".txt"
    ...
    for line in f0 : 
        ...
        if ( n == 1 ) :
            ...
            f2.write ( str ( "in" ) + str ( "|" ) + str ( TCP_protocol ) + str ( "|" ) + str ( Src_ip ) + str ( "|" ) + str ( Dest_ip ) + str ( "|" ) + str ( Src_port ) + str ( "|" ) + str ( Dest_port ) + str ( "|" ) + str ( Packets ) + str ( "|" ) + str ( Bytes ) + str ( "|" ) + str( Dt ) + str ( "|" ) + str ( "0.002" )+ str ( "|" ) + str ( "    S " ) + str ( "|" ) + str ( Remaining_flags ) + "\n" ) 
            if ( r==9 ) :
                f1.write ( str ( Unix_time ) + "," +  str ( Duration ) + "," + str ( Packets ) + "," + str ( Dest_ip ) + "," + str ( Src_ip ) + "," + str ( Dest_port ) + "," + str ( Src_port ) + "," + str ( TCP_protocol ) + "," + " A  S " + "\n" )
                f2.write ( str ( "out" ) + str ( "|" ) + str ( TCP_protocol ) + str ( "|" ) + str ( Dest_ip ) + str ( "|" ) + str ( Src_ip ) + str ( "|" ) + str ( Dest_port ) + str ( "|" ) + str ( Src_port ) + str ( "|" ) + str ( Packets ) + str ( "|" ) + str ( Bytes ) + str ( "|" ) + str( Dt ) + str ( "|" ) + str ( "0.002" )+ str ( "|" ) + str ( " A  S " ) + str ( "|" ) + str ( Remaining_flags ) + "\n" ) 
            ...
            if ( port < 65536 ) :
                ...
                ### File Operation : Write ### 
                f1.write ( str ( "in" ) + str ( "," ) + str ( TCP_protocol ) + str ( "," ) + str ( Src_ip ) + str ( "," ) + str ( Dest_ip ) + str ( "," ) + str ( Src_port ) + str ( "," ) + str ( Dest_port ) + str ( "," ) + str ( Packets ) + str ( "," ) + str ( Bytes ) + str ( "," ) + str( Dt ) + str ( "," ) + str ( "0.002" )+ str ( "," ) + str ( '    S ' ) + str ( Remaining_flags ) + "\n" )
                if ( r == 9 ) : 
                    f1.write ( str ( "out" ) + str ( "," ) + str ( TCP_protocol ) + str ( "," ) + str ( Dest_ip ) + str ( "," ) + str ( Src_ip ) + str ( "," ) + str ( Dest_port ) + str ( "," ) + str ( Src_port ) + str ( "," ) + str ( Packets ) + str ( "," ) + str ( Bytes ) + str ( "," ) + str( Dt ) + str ( "," ) + str ( "0.002" )+ str ( "," ) + str ( ' A    ' ) + str ( Remaining_flags ) + "\n" )
                    f1.write ( str ( "in"  ) + str ( "," ) + str ( TCP_protocol ) + str ( "," ) + str ( Src_ip ) + str ( "," ) + str ( Dest_ip ) + str ( "," ) + str ( Src_port ) + str ( "," ) + str ( Dest_port ) + str ( "," ) + str ( Packets ) + str ( "," ) + str ( Bytes ) + str ( "," ) + str( Dt ) + str ( "," ) + str ( "0.002" )+ str ( "," ) + str ( '   R  ' ) + str ( Remaining_flags ) + "\n" )
        ...
        ### Try Statement ###
            ...
            try :
                ...
                if ( next ( ip_internal ).strip() != '10.0.255.255' ) : 
                    ...
                    ### File Operation : Write ###
                    f1.write ( str ( "in" ) + str ( "," ) + str( TCP_protocol ) + str ( "," ) + str ( Src_ip ) + str ( "," ) + str ( Dest_ip_1 ) + str ( "," ) + str ( Src_port ) + str ( "," ) + str ( Dest_port ) + str ( "," ) + str ( Packets ) + str ( "," ) + str ( Bytes ) + str ( "," ) + str( Dt ) + str ( "," ) + str ( "0.002" )+ str ( "," ) + str ( '    S ' ) + "\n" ) 
                    if ( r == 9 ) : 
                        f1.write ( str ( "out" ) + str ( "," ) + str ( TCP_protocol ) + str ( "," ) + str ( Dest_ip_1 ) + str ( "," ) + str ( Src_ip ) + str ( "," ) + str ( Dest_port ) + str ( "," ) + str ( Src_port ) + str ( "," ) + str ( Packets ) + str ( "," ) + str ( Bytes ) + str ( "," ) + str( Dt ) + str ( "," ) + str ( "0.002" ) + str ( "," ) + str ( ' A    ' ) + "\n" ) 
                        f1.write ( str ( "in"  ) + str ( "," ) + str ( TCP_protocol ) + str ( "," ) + str ( Src_ip ) + str ( "," ) + str ( Dest_ip_1 ) + str ( "," ) + str ( Src_port ) + str ( "," ) + str ( Dest_port ) + str ( "," ) + str ( Packets ) + str ( "," ) + str ( Bytes ) + str ( "," ) + str( Dt ) + str ( "," ) + str ( "0.002" ) + str ( "," ) + str ( '   R  ' ) + "\n" ) 
            ...
            try : 
                ...
                if ( next ( ip_internal2 ).strip() != '10.0.255.255' ) : 
                    ...
                    ### File Operation : Write ###
                    f1.write ( str ( "in" ) + str ( "," ) + str( TCP_protocol ) + str ( "," ) + str ( Src_ip ) + str ( "," ) + str ( Dest_ip_2 ) + str ( "," ) + str ( Src_port ) + str ( "," ) + str ( Dest_port ) + str ( "," ) + str ( Packets ) + str ( "," ) + str ( Bytes ) + str ( "," ) + str( Dt ) + str ( "," ) + str ( "0.002" )+ str ( "," ) + str ( '     F' ) + "\n" ) 
                    if ( r!=9 ) : 
                        f1.write ( str ( "out" ) + str ( "," ) + str ( TCP_protocol ) + str ( "," ) + str ( Dest_ip_2 ) + str ( "," ) + str ( Src_ip ) + str ( "," ) + str ( Dest_port ) + str ( "," ) + str ( Src_port ) + str ( "," ) + str ( Packets ) + str ( "," ) + str ( Bytes ) + str ( "," ) + str( Dt ) + str ( "," ) + str ( "0.002" )+ str ( "," ) + str ( '   R  ' ) + "\n" ) 
...
def main () : 
    ...
    Scan_Rate = [50]                                                  # Scanning Rate                    # 
    Susc_Prop = [0.75]                                                # Susceptible Proportion           # 
